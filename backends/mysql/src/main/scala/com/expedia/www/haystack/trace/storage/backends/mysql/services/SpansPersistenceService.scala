...
package com.expedia.www.haystack.trace.storage.backends.mysql.services
...
class SpansPersistenceService(reader: MysqlTraceRecordReader,
                              writer: MysqlTraceRecordWriter)
