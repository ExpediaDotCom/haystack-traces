...
/**
  ...
  * @param maxByteSize       : maximum payload size to be received from backend server
  */
case class TraceBackendClientConfiguration(host: String, port:Int, maxByteSize: Int)
