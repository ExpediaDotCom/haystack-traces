...
package com.expedia.www.haystack.span.bufferer.config
...
object ProjectConfiguration {
  ...
  /**
    * span buffering related configuration like max buffered records, buffer window, poll interval
    * @return a span config object
    */
  def spanBufferConfig: SpanBufferConfiguration = {
    val cfg = config.getConfig("span.buffer")
    SpanBufferConfiguration(
