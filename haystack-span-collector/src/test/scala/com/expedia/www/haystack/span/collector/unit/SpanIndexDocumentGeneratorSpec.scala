...
import com.expedia.www.haystack.span.collector.config.entities.{IndexConfiguration, IndexField}
...
class SpanIndexDocumentGeneratorSpec extends FunSpec with Matchers {
  ...
  describe("Span to IndexDocument Generator") {
    it ("should extract serviceName, operationName, duration and create json document for indexing") {
      ...
      val doc = generator.createIndexDocument(spanBuffer).get
      doc.id should startWith(TRACE_ID)
      doc.json shouldBe "{\"duration\":0,\"spans\":[{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":600,\"tags\":{}},{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":500,\"tags\":{}},{\"service\":\"service2\",\"operation\":\"op3\",\"duration\":1000,\"tags\":{}}]}"
    }
    ...
    it ("should not create an index document if service name is absent") {
      ...
      val doc = generator.createIndexDocument(spanBuffer)
      doc shouldBe None
    }
    ...
    it ("should extract tags along with serviceName, operationName and duration and create json document for indexing") {
      ...
      val doc = generator.createIndexDocument(spanBuffer).get
      doc.id should startWith(TRACE_ID)
      doc.json shouldBe "{\"duration\":0,\"spans\":[{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":100,\"tags\":{\"role\":\"haystack\"}},{\"service\":\"service1\",\"operation\":\"op2\",\"duration\":200,\"tags\":{\"role\":\"haystack\",\"errorCode\":3}},{\"service\":\"service2\",\"operation\":\"op3\",\"duration\":1000,\"tags\":{\"errorCode\":3}}]}"
    }
    ...
    it ("should respect enabled flag of tags create right json document for indexing") {
      ...
      val doc = generator.createIndexDocument(spanBuffer).get
      doc.id should startWith(TRACE_ID)
      doc.json shouldBe "{\"duration\":0,\"spans\":[{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":100,\"tags\":{}},{\"service\":\"service1\",\"operation\":\"op2\",\"duration\":200,\"tags\":{\"errorCode\":3}}]}"
    }
    ...
    it ("one more test to verify the tags are indexed") {
      ...
      val doc = generator.createIndexDocument(spanBuffer).get
      doc.id should startWith(TRACE_ID)
      doc.json shouldBe "{\"duration\":0,\"spans\":[{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":100,\"tags\":{\"errorCode\":5}},{\"service\":\"service1\",\"operation\":\"op2\",\"duration\":200,\"tags\":{\"errorCode\":3}}]}"
    }
    ...
    it ("should extract unique tag values along with serviceName, operationName and duration and create json document for indexing") {
      ...
      val doc = generator.createIndexDocument(spanBuffer).get
      doc.id should startWith(TRACE_ID)
      doc.json shouldBe "{\"duration\":0,\"spans\":[{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":100,\"tags\":{\"role\":\"haystack\"}},{\"service\":\"service1\",\"operation\":\"op1\",\"duration\":200,\"tags\":{\"role\":\"haystack\"}}]}"
    }
  }
}
